...
<?php if (in_array($plugin->getBookingBuilder()->getLastBooking()->getStatus(), array(SLN_Enum_BookingStatus::PAID)) && $plugin->getBookingBuilder()->getLastBooking()->getAmount() > 0.0): ?>
    <?php include '_salon_thankyou_alert_paid.php' ?>
<?php endif; ?>
<div class="row sln-form-actions-wrapper ">

    <?php if (!in_array($plugin->getBookingBuilder()->getLastBooking()->getStatus(), array(SLN_Enum_BookingStatus::PAID, SLN_Enum_BookingStatus::CONFIRMED, SLN_Enum_BookingStatus::CANCELED, SLN_Enum_BookingStatus::ERROR))): ?>
