    ...
    <div class="col-xs-12 col-md-8">
        <div class="row">
            ...
            ?>
                ...
                <div class="col-xs-12 col-sm-<?php echo $field == 'address' ? 12 : $width ?> <?php echo 'field-'.$field ?> <?php if($type !== 'checkbox'){ echo 'sln-input sln-input--simple'; } ?> <?php echo $type ? 'sln-'.$type  : '' ?>
