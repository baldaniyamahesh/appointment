...
function eightmedi_lite_custom_customize_register( $wp_customize ) {
   ...
   //social facebook link
	...
	//footer settings
	$wp_customize->add_setting('eightmedi_lite_footer_widgets_layout', array(
		'default' => '4',
		'capability' => 'edit_theme_options',
		'sanitize_callback' => 'eightmedi_lite_sanitize_integer',
	));

	$wp_customize->add_control('eightmedi_lite_footer_widgets_layout', array(
		'type' => 'radio',
		'label' => __('Top Footer Widgets Blocks Layout', 'eightmedi-lite'),
		'section' => 'eightmedi_lite_footer_setting',
		'choices' => array(
			'3' => __('3 Columns','eightmedi-lite'),
			'4' => __('4 Columns','eightmedi-lite')
		),
	));

	//Adding the InnerPage Settings
	$wp_customize->add_panel('eightmedi_lite_inner_page',array(
		'priority' => '60',
		'capability' => 'edit_theme_options',
		'theme_supports' => '',
		'title' => __('Inner Page Settings','eightmedi-lite'),
	));

	//single post settings
	$wp_customize->add_section('eightmedi_lite_single_post_setting', array(
		'priority' => 10,
		'title' => __('Post Settings', 'eightmedi-lite'),
		'panel' => 'eightmedi_lite_inner_page'
	));

	$wp_customize->add_setting('eightmedi_lite_post_featured_img',array(
		'default' => '1',
		'sanitize_callback' => 'eightmedi_lite_sanitize_radio_integer',
	));
	$wp_customize->add_control('eightmedi_lite_post_featured_img',array(
		'type' => 'radio',
		'label' => __('Show/Hide Featured Image','eightmedi-lite'),
		'description' => __('Selecting No will Hide Featured Image From Post','eightmedi-lite'),
		'section' => 'eightmedi_lite_single_post_setting',
		'choices' => array(
			'1' => __('Yes','eightmedi-lite'),
			'0' => __('No','eightmedi-lite')
		)
