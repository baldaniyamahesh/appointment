...
function vw_hospital_lite_customize_register( $wp_customize ) {
	...
	$wp_customize->add_setting('vw_hospital_lite_theme_options',array(
        'default' => __('Right Sidebar','vw-hospital-lite'),
        'sanitize_callback' => 'vw_hospital_lite_sanitize_choices'	        
	) );
	...
	$wp_customize->add_setting('vw_hospital_lite_page_layout',array(
        'default' => __('One Column','vw-hospital-lite'),
        'sanitize_callback' => 'vw_hospital_lite_sanitize_choices'
	));
    ...
    $wp_customize->add_setting('vw_hospital_lite_loader_icon',array(
        'default' => __('Two Way','vw-hospital-lite'),
        'sanitize_callback' => 'vw_hospital_lite_sanitize_choices'
	));
	...
	$wp_customize->add_setting('vw_hospital_lite_slider_content_option',array(
        'default' => __('Center','vw-hospital-lite'),
        'sanitize_callback' => 'vw_hospital_lite_sanitize_choices'
	));
    ...
    $wp_customize->add_setting('vw_hospital_lite_blog_layout_option',array(
        'default' => __('Default','vw-hospital-lite'),
        'sanitize_callback' => 'vw_hospital_lite_sanitize_choices'
    ));
    ...
    $wp_customize->add_setting('vw_hospital_lite_excerpt_settings',array(
        'default' => __('Excerpt','vw-hospital-lite'),
        'transport' => 'refresh',
        'sanitize_callback' => 'vw_hospital_lite_sanitize_choices'
    ));
	...
	//Content Creation
	$wp_customize->add_section( 'vw_hospital_lite_content_section' , array(
    	'title' => __( 'Customize Home Page Settings', 'vw-hospital-lite' ),
		'priority' => null,
		'panel' => 'vw_hospital_lite_panel_id'
	) );

	$wp_customize->add_setting('vw_hospital_lite_content_creation_main_control', array(
		'sanitize_callback' => 'esc_html',
	) );

	$homepage= get_option( 'page_on_front' );

	$wp_customize->add_control(	new VW_Hospital_Lite_Content_Creation( $wp_customize, 'vw_hospital_lite_content_creation_main_control', array(
		'options' => array(
			esc_html__( 'First select static page in homepage setting for front page.Below given edit button is to customize Home Page. Just click on the edit option, add whatever elements you want to include in the homepage, save the changes and you are good to go.','vw-hospital-lite' ),
		),
		'section' => 'vw_hospital_lite_content_section',
		'button_url'  => admin_url( 'post.php?post='.$homepage.'&action=edit'),
		'button_text' => esc_html__( 'Edit', 'vw-hospital-lite' ),
	) ) );
	...
	$wp_customize->add_setting('vw_hospital_lite_scroll_top_alignment',array(
        'default' => __('Right','vw-hospital-lite'),
        'sanitize_callback' => 'vw_hospital_lite_sanitize_choices'
	));
...
final class VW_Hospital_Lite_Customize {
	...
	public function sections( $manager ) {
		...
		// Register sections.
		$manager->add_section(new VW_Hospital_Lite_Customize_Section_Pro($manager,'example_1',array(
			'priority'	=> 1,
		...
		// Register sections.
		$manager->add_section(new VW_Hospital_Lite_Customize_Section_Pro($manager,'example_2',array(
			'priority'   => 1,
